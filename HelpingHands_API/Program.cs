...
using HelpingHands_Business.Repository;
...
if (app.Environment.IsDevelopment())
{
    ...
    app.UseSwaggerUI(options => {
        options.SwaggerEndpoint("/swagger/v1/swagger.json", "HelpingHands_APIV1");
        options.SwaggerEndpoint("/swagger/v2/swagger.json", "HelpingHands_APIV2");
    });
}
